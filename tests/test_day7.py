...
def test_add_reachable_lines_with_concat():
    input = '''190: 10 19
3267: 81 40 27
83: 17 5
156: 15 6
...
21037: 9 7 18 13
292: 11 6 16 20'''
    assert add_reachable_lines ( input, True ) == 11387
...
def test_is_reachable_with_concat(target, numbers, expected_result) -> None:
    assert is_reachable(target, numbers, True) == expected_result
